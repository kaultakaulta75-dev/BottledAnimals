...
The Animal Digitizer, Materializer, Breeder and Growth Accelerator now use persistent inventories, timed Forge Energy processing and a shared menu. The Drop Extractor and Animal Rancher still use the interim alpha interaction while their persistent implementations are ported. The Basic Generator exposes a real NeoForge FE capability and pushes energy to adjacent consumers.
